...
public sealed class UserDisplayNameTests
{
    ...
    public void ConstructorWhenValueIsNullThrowsArgumentException()
    {
        ...
        // Act
        Action act = () => _ = new UserDisplayName(value);
    ...
    public void ConstructorWhenValueContainsPaddingTrimsValue()
    {
        ...
        // Act
        var displayName = new UserDisplayName(value);

        // Assert
        displayName.Value.Should().Be("sample");
    }
    ...
    {
        // Arrange
        var displayName = new UserDisplayName("sample");

        // Act
        var text = displayName.ToString();
